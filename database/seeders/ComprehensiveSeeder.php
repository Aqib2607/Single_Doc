    ...
    private function seedBlogs(): void
    {
        $blogs = [
            ...
            [
                ...
                'image' => '/images/blog/joint-health.jpg',
    ...
    private function seedGalleries(): void
    {
        $galleries = [
            [
                ...
                'url' => '/videos/cardiac-catheterization.mp4',
                'type' => 'video',
                'category' => 'Procedures',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'url' => '/images/gallery/pediatric-room.jpg',
                'type' => 'image',
                'category' => 'Facilities',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'url' => '/images/gallery/dermatoscope.jpg',
                'type' => 'image',
                'category' => 'Equipment',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'url' => '/videos/knee-replacement.mp4',
                'type' => 'video',
                'category' => 'Procedures',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'url' => '/images/gallery/eeg-room.jpg',
                'type' => 'image',
                'category' => 'Facilities',
                'created_at' => now(),
                'updated_at' => now(),
